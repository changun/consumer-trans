...
def main(argv):
    ...
    # download the csv file provided by Mint.com
    out.write(c.downloadAllTransactionsCSV())

    # scrap the pages directly to get more detailed information
...
class MintCloudClient(mechanize.Browser):
    ...
    def allTransactions(self, rnd='1325292983069'):
        ...
        return alltx
    def downloadAllTransactionsCSV(self):
        page = self.open("transactionDownload.event")
        return page.read()
